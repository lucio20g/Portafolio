...
<body>
    ...
    <header>
        <a href="../encuestador.php" class="logo"><img class="log" src="../img/GENNS-PhotoRoom.png-PhotoRoom.png"></i>ENCUESTADOR</a>
            ...
            <div>
                ...
                <script>
                    document.getElementById("check5").onclick = function () {
                        ...
                        if (document.getElementById("check2" ,).disabled) {
                            document.getElementById("check2" ,).disabled = false
                        } else {
                            document.getElementById("check2").disabled = true
                        }

                        if (document.getElementById("check3" ,).disabled) {
                            document.getElementById("check3" ,).disabled = false
                        } else {
                            document.getElementById("check3").disabled = true
                        }

                        if (document.getElementById("check4" ,).disabled) {
