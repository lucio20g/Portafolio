...
<head>
    ...
    <link rel="stylesheet" href="estilos/tabla2.css">
...
<body>
    <header>
        ...
        <ul class="navbar">
            <li><a href="crud/encuestadores/formularioE.php">Encuestadores</a></li>
            <li><a href="visualizaciongeneral.php">Visualizar</a></li>
        </ul>
    ...
    <main>
        ...
        $conn = new mysqli($servername, $username, $password, $dbname);
            ...
            $query = "SELECT ID_ENCUESTA, ID_ENCUESTADOR, PREGUNTA_A, PREGUNTA_B, PREGUNTA_C,
            PREGUNTA_D, PREGUNTA_E, PREGUNTA_F, PREGUNTA_G, PREGUNTA_H, PREGUNTA_I,
            PREGUNTA_J, PREGUNTA_K, PREGUNTA_L, SEXO, PUNTAJE, NIVEL FROM preguntas";
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<th>ID</th><th>ID_ENCUESTADOR</th><th>PREGUNTA_A</th><th>PREGUNTA_B</th><th>PREGUNTA_C</th><th>PREGUNTA_D</th>
