        ...
        if (isset($_SESSION['ID'])) {
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><a href='modificarEncuesta.php?id=" . $row['ID_ENCUESTA'] . "'><img src='img/edit.png' width='40px' height='40px'></img></a></td>";
                    echo "<td><a href='eliminarEncuesta.php?id=" . $row['ID_ENCUESTA'] . "'><img src='img/borrar.png' width='40px' height='40px'></img></a></td>";
