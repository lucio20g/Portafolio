...
<head>
    ...
    <title>GENNS|Supervisores</title>
</head>
...
<body>
    ...
    <main>
        <?php
            ...
            $query = "SELECT * FROM superiores WHERE CARGO = 'Supervisor'";
            ...
            if ($result->num_rows > 0){
                ...
                echo "<th>DNI</th><th>USUARIO</th><th>CARGO</th>";
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><a href='modificarSupervisor.php?dni=" . $row['DNI'] . "'><button>Modificar</button></a></td>";
                    echo "<td>" ."<a href='eliminarSupervisor.php'><button>Eliminar</button></a>" . "</td>";
                    echo "</tr>";
                }
            echo "</table>";
        } else {
            echo "No se encontraron Supervisores.";
        }
        ?>
    <a href="agregarSupervisores.php"><button type="button">Agregar</button></a>
    </main>
    <br>
