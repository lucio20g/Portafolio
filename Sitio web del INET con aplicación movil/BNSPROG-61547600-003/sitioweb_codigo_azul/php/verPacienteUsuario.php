...
<body>
    <nav class="nav">
        <ul>
            <li><a href="../paginas/usuario.html"><h2 class="title">Clínica Online</h2></a></li>
            <li><a href="../paginas/pacientesUsuario.html"><p class="txt">Pacientes</p></a></li>
            <li><a href="../paginas/enfermerosUsuario.html"><p class="txt">Enfermeros</p></a></li>
