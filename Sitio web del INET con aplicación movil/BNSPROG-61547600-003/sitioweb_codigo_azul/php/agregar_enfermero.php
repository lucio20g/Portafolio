...
// Se obtienen los datos del formulario HTML enviado por el método POST y se almacenan en variables
$dni = $_POST["DNI"];
$nombre = $_POST["Nombre"];
...
if ($conn->query($sql) === TRUE) {
    // Si la inserción fue exitosa, redirige al usuario a la página enfermeros.html
    header("Location: ../paginas/enfermeros.html");
